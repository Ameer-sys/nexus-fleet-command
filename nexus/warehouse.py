...
def create_packages() -> dict[str, WarehousePackage]:
    items = (
        ...
        WarehousePackage("ELECTRONICS-01", "Electronics", (1.15, 1.55), "FRAGILE", 7, "MEDIUM", "STORAGE B"),
        ...
        WarehousePackage("MED-KIT-01", "Medical Kit", (0.45, 1.65), "MEDICAL", 10, "CRITICAL", "MEDICAL"),
